...
# Rodando a PCA:
afpc <- prcomp(notasfatorial_std) # aula teórica se resume nesta única linha
...
# representa a quantidade de variÃ¡veis da base de dados.

# center: médias de cada variável utilizadas para apÃ³s a padronizaÃ§Ã£o.

# scale: desvios-padrão de cada variÃ¡vel utilizadas para a padronizaÃ§Ã£o.
...
#Na construÃ§Ã£o de rankings no R, devemos efetuar a multiplicação por -1, 
#visto que os scores fatoriais das observaçõµes mais fortes sÃ£o, por padrão, 
